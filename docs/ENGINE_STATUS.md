...
```
1. Backtesting Engine          ██████████████████░░  88%  (+10)
2. ML Signal Combination       ██████████████████░░  90%
3. Regime Detection            █████████████████░░░  83%
4. Correlation-Aware Sizing    ███████████████████░  96%
5. Institutional Signals       ████████████████░░░░  78%  (+15)
─────────────────────────────────────────────────────
Overall Tier 1 Engine          █████████████████░░░  87%  (+7)
```
...
Priority order for remaining ~13% to completion:

| # | Task | Component | Impact | Effort |
|---|---|---|---|---|
| 1 | Portfolio-level backtest | Backtesting | High | High |
| 2 | Congressional trading (House stock watcher) | Institutional | Medium | Low |
| 3 | Dark pool / block trade proxy | Institutional | Low | Medium |
